const BaseMinSidebar = () => {
  return (
    <>
      <div className="flex justify-end p-2 shadow-lg">
        <div
          id="sidebar-mini"
          className="hs-overlay"
        >
          <div className="flex flex-col items-center justify-center gap-y-2 py-4 mx-auto">
